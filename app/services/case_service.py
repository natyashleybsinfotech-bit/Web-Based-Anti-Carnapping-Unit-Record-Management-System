...
def create_case(case_data):
    ...
    try:
        ...
        required_fields = ['reference_no', 'complainant_name', 'complainant_email', 'incident_location']
        ...
        return {"status": "success", "message": "Case created successfully", "case": case_record}
...
def update_case_status(case_id, new_status):
    ...
    try:
        ...
        return {"status": "success", "message": f"Case status updated to {new_status}", "update": update_record}
...
def assign_case_to_officer(case_id, officer_id):
    ...
    try:
        ...
        return {"status": "success", "message": "Case assigned successfully", "assignment": assignment}
